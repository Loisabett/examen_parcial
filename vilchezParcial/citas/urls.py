...
from .views import (home, documentoList, documentoCreate, documentoUpdate,documentoDelete, seguroList, 
                    seguroCreate, seguroUpdate, seguroDelete, PacienteList, PacienteCreate, 
                    PacienteUpdate, PacienteDelete, especialidadesList, especialidadesCreate, 
                    especialidadesUpdate, especialidadesDelete, doctorList, doctorCreate, 
                    doctorUpdate, doctorDelete, citasList, citasCreate, citasUpdate, citasDelete)
